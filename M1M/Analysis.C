{
  ...
  HipoChain chain;
  chain.Add("/lustre19/expphy/volatile/clas12/rg-d/production/trig/v2/trig/recon/018419/rec_clas_018419.evio.00000-00004.hipo");
  ...
  TH1F hP("pi0P","Invariant Mass to 2#gamma",100,0,1.);
